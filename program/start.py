...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/c118c574c4fadfd656a74.jpg",
        caption=f"""Programmer [Lucifer](https://t.me/DeV_PHPJS) 𖡼\nᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼\nғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("℡ ᯓ 𝐷𝐸⃟𝑉 𝐸𝐼𝑇𝐻𝑂𝑁•", url=f"https://t.me/TTTLL0"),
            ],
            [
                InlineKeyboardButton(
                    "- لــ ايــثــون .", url=f"https://t.me/EITHON1"
                ),
            ],
            [
                InlineKeyboardButton("♡اضف البوت الى مجموعتك♡", url=f"https://t.me/THOR_MU?startgroup=true"),
            ]
         ]
     )
  )
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("𓌹℡ ᯓ 𝐷𝐸⃟𝑉 𝐸𝐼𝑇𝐻𝑂𝑁", url=f"https://t.me/TTTLL0"),
            ],
            [
                InlineKeyboardButton(
            ...
            return await m.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        url=f'https://t.me/THOR_MU?startgroup=true'),
                        ],
                    ]
                )
            )
